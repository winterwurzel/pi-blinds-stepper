...
class StepperHandler():
    ...
    def rotations(self, rotationsToTake, direction = __CLOCKWISE):
        print("Taking " + str(rotationsToTake) + " rotations.")

        for x in range(rotationsToTake):
            self.step(200)
...
# full rotations
#stepperHandler.rotations(9)

# Go forwards once
stepperHandler.step(200 * 5)
